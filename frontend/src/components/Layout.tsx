  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        zIndex: 200, transition: 'all 0.3s ease', pointerEvents: 'none',
      }} />
      ...
      {sidebarOpen && !pinned && (
        <div onClick={() => setSidebarOpen(false)} style={{
          ...
          backdropFilter: 'blur(2px)', zIndex: 98, animation: 'fadeIn 0.2s ease',
        }} />
      )}
      ...
      >
        {/* Logo */}
        <div style={{
          padding: '24px 20px 20px', borderBottom: '1px solid #161616',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{
              background: 'linear-gradient(135deg, #dc2626, #991b1b)', borderRadius: 10,
              padding: 9, display: 'flex', boxShadow: '0 4px 12px rgba(220,38,38,0.3)',
            }}>
        ...
        <nav style={{ flex: 1, padding: '16px 12px', overflowY: 'auto' }}>
          <div style={{
            ...
            color: '#27272a', fontWeight: 700, padding: '0 8px', marginBottom: 10,
          }}>Navigation</div>
          ...
          {visibleItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && <ChevronRight size={12} style={{ marginLeft: 'auto', color: '#dc2626' }} />}
              </Link>
            );
          })}
        </nav>
        ...
        <div style={{ padding: '12px', borderTop: '1px solid #161616' }}>
          <div style={{
            ...
            background: '#111', borderRadius: 8, marginBottom: 8, border: '1px solid #1a1a1a',
          }}>
            <div style={{
              width: 34, height: 34,
              background: 'linear-gradient(135deg, #dc2626, #991b1b)',
              borderRadius: '50%', display: 'flex', alignItems: 'center',
              justifyContent: 'center', flexShrink: 0, boxShadow: '0 2px 8px rgba(220,38,38,0.3)',
            }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{
                fontSize: 10, color: roleColor[user?.role || ''] || '#52525b',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8, color: '#52525b', cursor: 'pointer', fontSize: 12,
              fontWeight: 500, transition: 'all 0.2s', letterSpacing: 0.5,
            }}
            onMouseEnter={e => {
      ...
      <main style={{
        ...
        minHeight: '100vh', background: '#09090b', overflow: 'auto',
      }}>
        {/* Top bar */}
        <div style={{
          height: 56, borderBottom: '1px solid #111', display: 'flex',
          ...
          <button
            ...
            style={{
              ...
              alignItems: 'center', color: '#52525b', transition: 'all 0.2s',
            }}
            onMouseEnter={e => {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{
              ...
              letterSpacing: 3, textTransform: 'uppercase', color: '#3f3f46',
            }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              padding: '5px 12px 5px 6px', background: '#111',
              ...
              <span style={{ fontSize: 12, color: '#a1a1aa', fontWeight: 500 }}>{user?.username}</span>
              <span style={{
                fontSize: 9, color: roleColor[user?.role || ''] || '#52525b',
        ...
        {/* Page content */}
        <div style={{
          padding: '36px 32px', maxWidth: 1280, margin: '0 auto',
