              ...
              <div style={{ display:'flex', alignItems:'flex-end', gap:10, height:110 }}>
                {conBars.map(c => (
                  <div key={c.name} style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', gap:6 }}>
                    ...
                    <div style={{ width:'100%', background:'#2563eb', height: maxCon ? `${(c.count/maxCon)*80}px` : 4, minHeight:4, transition:'height 0.5s' }}/>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={l.id} className="wf-row">
                    ...
                    <td style={{...S.td, color:'#a1a1aa'}}>₹{l.overtime_rate}/hr</td>
                    <td style={S.td}>{l.contractor_detail?.user_detail?.first_name||'—'}</td>
                    <td style={S.td}>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={c.id} className="wf-row">
                    ...
                    <td style={S.td}>{c.supervisor_detail?.first_name||'—'}</td>
